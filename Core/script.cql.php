...
create table archivoHist(projectname text,branchname text,docname text,owner text,historial list<frozen <archivostruct>>,primary key(projectname, branchname,docname));